...
def _initialize_info(username: str, password: str, store_name: str = None) -> tuple[str, str, str, str, str]:
    store_id = ""
...
def _create_product(cookie: str, store_id: str, product_name: str, category: str, price: float, quantity: int) -> tuple[
...
def test_change_product_quantity_negative_quantity_fail():
    ...
    product_id, product_name, category, price, quantity = _create_product(cookie, store_id, _generate_product_name(),
                                                                          "A", 5.50, 10)
    res = system.change_product_quantity_in_store(
        cookie, store_id, product_id, new_quantity
    )
    assert not res.succeeded()
...
def test_change_amount_in_cart_wrong_product_fail():
    ...
    wrong_product = "cofee"
    system.save_product_in_cart(cookie, store_id, product_id, 1)
    res = system.change_product_quantity_in_cart(
...
def test_appoint_store_manager_owner_chain_fail():
    ...
    system.appoint_manager(cookie, store_id, new_manager_username)
    response = system.add_manager_permission(cookie, store_id, new_manager_username, new_responsibility)
    assert response.succeeded(), response.get_msg()
...
def test_remove_responsibility_success():
    ...
    res = system.remove_manager_permission(cookie, store_id, new_manager_username, new_responsibility)
    assert res.succeeded()
...
def test_default_permissions_success():
    ...
    res = system.remove_manager_permission(
        cookie, store_id, new_manager_username,
        default_permission
    )
    assert res.succeeded()
...
def test_add_responsibility_twice_success():
    ...
    system.appoint_manager(cookie, store_id, new_manager_username)
    system.add_manager_permission(cookie, store_id, new_manager_username, new_responsibility)
    res = system.add_manager_permission(
...
def test_manage_products_permission_success():
    ...
    price = 5.50
    quantity = 10
    response = system.create_product(new_manager_cookie, store_id, product_name, category, price, quantity)
    assert response.succeeded(), response.get_msg()
...
def test_manage_products_no_permission_fail():
    ...
    price = 5.50
    quantity = 10
    res = system.create_product(new_manager_cookie, store_id, product_name, category, price, quantity)
    assert not res.succeeded()
...
def test_buy_delete_product():
    ...
    for i in range(100):
        ...
        system.add_manager_permission(cookie, store_id, new_manager_username, "appoint_manager")
        system.add_manager_permission(cookie, store_id, new_manager_username, "manage_products")
        product_id, product_name, category, price, quantity = _create_product(new_manager_cookie, store_id,
                                                                              _generate_product_name(),
                                                                              "A", 5.50, 3)
        system.save_product_in_cart(cookie, store_id, product_id, quantity=1)
...
def test_purchase_edit_simple_rule_invalid_fail():
    ...
    parent_id = '1'
    system.add_purchase_rule(cookie, store_id, _simple_rule_details_age(), 'simple', parent_id)
    response_edit = system.edit_purchase_rule(cookie, store_id, _simple_rule_details_age_invalid_operator(), '2', 'simple')
...
def test_purchase_edit_simple_rule_missing_key_fail():
    ...
    response_edit = system.edit_purchase_rule(cookie, store_id, _simple_rule_details_age_missing_key_target(), '2', 'simple')
    assert not response_edit.succeeded()
...
def test_purchase_edit_complex_rule_invalid_fail():
    ...
    parent_id = '1'
    system.add_purchase_rule(cookie, store_id, _complex_rule_details_or(), 'complex', parent_id)
    response_edit = system.edit_purchase_rule(cookie, store_id, _complex_rule_details_invalid_operator(), '2', 'complex')
    assert not response_edit.succeeded()
...
def test_purchase_edit_complex_missing_key_fail():
    ...
    parent_id = '1'
    system.add_purchase_rule(cookie, store_id, _complex_rule_details_or(), 'complex', parent_id)
    response_edit = system.edit_purchase_rule(cookie, store_id, _complex_rule_details_missing_operator(), '2', 'complex')
    assert not response_edit.succeeded()
...
def test_purchase_edit_complex_success_simple_child_invalid():
    ...
    response_edit_simple = system.edit_purchase_rule(cookie, store_id, _simple_rule_details_age_invalid_operator(), '3', 'simple')
...
def test_purchase_founder_edit_rule_to_other_store_fail_but_self_success():
    ...
    response_edit_right = system.edit_purchase_rule(new_cookie, new_store_id, _complex_rule_details_and(), '2', 'complex')
...
def test_purchase_cart_with_complex_or_rule_success():
    ...
    system.add_purchase_rule(cookie, store_id, _complex_rule_details_or(), 'complex', parent_id)
    system.add_purchase_rule(cookie, store_id, _simple_rule_details_age(), 'simple', '2')
    product_simple_rule = {'context': {'obj': 'product', 'identifier': product_id}, 'operator': 'less-than', 'target': 10}
