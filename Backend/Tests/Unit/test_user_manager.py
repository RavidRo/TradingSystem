...
def set_up(request):
    ...
    IUser.use_mock = True
    UserManager._get_cookie_user().clear()
    UserManager._get_username_user().clear()
    yield
...
def test_enter_system_creates_unique_cookie():
    ...
    assert len(UserManager._get_cookie_user()) == len(cookies)
...
def test_does_not_register_when_registration_fails(cookie):
    UserManager._get_cookie_user()[cookie].can_register = False
    UserManager.register("username", "password", cookie)
    assert "username" not in UserManager._get_username_user()
...
def test_login_does_not_get_back_old_data_on_fail(cookie, cookie2):
    UserManager.register("username", "password", cookie)
    UserManager._get_cookie_user()[cookie].can_login = False
    UserManager.login("username", "password", cookie2)
    assert not UserManager._get_cookie_user()[cookie] == UserManager._get_cookie_user()[cookie2]
...
def test_add_to_cart_deligate_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._add_to_cart
...
def test_get_cart_details_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._get_cart_details
...
def test_remove_product_from_cart_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._remove_product_from_cart
...
def test_change_product_quantity_in_cart_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._change_product_quantity_in_cart
...
def test_purchase_completed_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._purchase_completed
...
def test_get_cart_price_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._get_cart_price
...
def test_create_store_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._create_store
...
def test_get_purchase_history_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._get_purchase_history
...
def test_remove_product_from_store_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._remove_product_from_store
...
def test_change_product_quantity_in_store_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._change_product_quantity_in_store
...
def test_appoint_owner_deligates_to_user_successfully(cookie, cookie2):
    UserManager.register(
        UserManager._get_cookie_user()[cookie2].get_username().get_obj().get_val(), "", cookie2
    )
    UserManager.appoint_owner(
        cookie, "", UserManager._get_cookie_user()[cookie2].get_username().get_obj().get_val()
    )
    assert UserManager._get_cookie_user()[cookie]._appoint_owner
...
def test_appoint_owner_fails_when_given_username_does_not_exist(cookie):
    ...
    assert not UserManager._get_cookie_user()[cookie]._appoint_owner and not result.succeeded()
...
def test_appoint_manager_deligates_to_user_successfully(cookie, cookie2):
    ...
    assert UserManager._get_cookie_user()[cookie]._appoint_manager
...
def test_appoint_manager_fails_when_given_username_does_not_exist(cookie):
    ...
    assert not UserManager._get_cookie_user()[cookie]._appoint_manager and not result.succeeded()
...
def test_add_manager_permission_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._add_manager_permission
...
def test_remove_manager_permission_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._remove_manager_permission
...
def test_remove_appointment_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._remove_appointment
...
def test_get_store_appointments_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._get_store_appointments
...
def test_get_store_purchase_history_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._get_store_purchase_history
...
def test_get_any_store_purchase_history_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._get_any_store_purchase_history
...
def test_get_any_user_purchase_history_deligates_to_user_successfully(cookie):
    ...
    assert UserManager._get_cookie_user()[cookie]._get_any_user_purchase_history
