...
class SearchEngine:
	...
	def search_products(product_name : str, category : str, min_price : float, max_price : float, *keywords) -> Response[list[product]]:
		...
		return filter(filter_predicate, all_products)
