...
class TradingSystem(ITradingSystem):
    ...
    def get_stores_details(self) -> response[list[StoreData]]:
        return self.trading_system_manager.get_stores_details()


    def get_products_by_store(self,store_id : str) -> response[list[ProductData]]:
        return self.trading_system_manager.get_products_by_store(store_id)


    def search_products(self,product_name="", category=None, min_price=None, max_price=None, **kwargs) -> response[list[ProductData]]:
        return self.trading_system_manager.search_products(product_name, category, min_price, max_price, **kwargs)


    def add_to_cart(self,cookie : str, product_id : str, quantity=1) -> response[None]:
        return self.trading_system_manager.search_products(cookie, product_id, quantity)


    def get_cart_details(self,cookie : str) -> response[ShoppingCartData]:
        return self.trading_system_manager.get_cart_details(cookie)


    def remove_product_from_cart(self,cookie : str, product_id : str, quantity=1) -> response[None]:
        return self.trading_system_manager.remove_product_from_cart(cookie, product_id, quantity)


    def purchase_cart(self,cookie : str) -> response[float]:
    ...
    def create_store(self,cookie : str, name : str) -> response[None]:
        return self.trading_system_manager.create_store(cookie, name)

    def ger_purchase_history(self,cookie : str) -> response[list[PurchaseDetailsData]]:
    ...
    def create_product(self,cookie : str, store_id : str, name : str, price : float) -> response[None]:
        return self.trading_system_manager.create_product(cookie, store_id, name, price)

    def add_products(self,cookie : str, store_id : str, product_id : str, quantity : int) -> response[None]:
        return self.trading_system_manager.add_products(cookie, store_id, product_id, quantity)


    def remove_products(self,cookie : str, store_id : str, product_id : str, quantity : int) -> response[None]:
        return self.trading_system_manager.remove_products(cookie, store_id, product_id, quantity)


    def set_product_price(self,cookie : str, store_id : str, product_id : str, new_price : float) -> response[None]:
        return self.trading_system_manager.set_product_price(cookie, store_id, product_id, new_price)

    def appoint_owner(self,cookie : str, store_id : str, username : str) -> response[None]:
        return self.trading_system_manager.appoint_owner(cookie, store_id, username)

    def appoint_manager(self,cookie : str, store_id : str, username : str) -> response[None]:
        return self.trading_system_manager.appoint_manager(cookie, store_id, username)

    def add_manager_permission(self,cookie : str, store_id : str, username : str, permission_number : int) -> response[None]:
        return self.trading_system_manager.add_manager_permission(cookie, store_id, username, permission_number)


    def remove_manager_permission(self,cookie : str, store_id : str, username : str, permission_number : int) -> response[None]:
        return self.trading_system_manager.remove_manager_permission(cookie, store_id, username, permission_number)

    def remove_appointment(self,cookie : str, store_id : str, username : str) -> response[None]:
        return self.trading_system_manager.remove_appointment(cookie, store_id, username)


    def get_store_appointments(self,cookie : str, store_id : str) -> response[ResponsibilityData]:
        return self.trading_system_manager.get_store_appointments(cookie, store_id)


    def get_store_purchases_history(self,cookie : str, store_id : str) -> response[list[PurchaseDetailsData]]:
        return self.trading_system_manager.get_store_purchases_history(cookie, store_id)

    #System Manager
    #====================

    def get_user_purchase_history(self,cookie : str, username : str) -> response[list[PurchaseDetailsData]]:
